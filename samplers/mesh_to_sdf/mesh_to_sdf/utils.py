...
def sample_uniform_points_in_unit_sphere(amount, size=1):
    unit_sphere_points = np.random.uniform(-1, 1, size=(amount * 2 + 20, 3)) * size
    unit_sphere_points = unit_sphere_points[np.linalg.norm(unit_sphere_points, axis=1) < size]
