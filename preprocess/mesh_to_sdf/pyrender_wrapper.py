...
def render_normal_and_depth_buffers(mesh, camera, camera_transform, resolution, multisampling=False):
    global suppress_multisampling
    suppress_multisampling = ~multisampling
    ...
    if not isinstance(resolution, int):
        ...
        res_x=res_y=resolution
    renderer = pyrender.OffscreenRenderer(res_x, res_y)
